...
mainApp.controller('CommuneController', function CommuneController($scope, $rootScope, $routeParams, $http, $location, googleChartApiPromise) {
    $rootScope.lastPage = $location.$$path;
    $rootScope.alertType = null;

    $http.get('/api/communes/'+$routeParams.code)
    .then(function (response) {
        $rootScope.alertType = null;
        $scope.area = response.data;
...
mainApp.controller('SearchController', function ($scope, $rootScope, $location, $http) {
    $rootScope.lastPage = $location.$$path;
    $rootScope.alertType = null;
    ...
    $scope.loadData = function(q, p){
      $http.get('/api/search?q=' + q + '&page=' + p)
      .then(function (response) {
          $rootScope.alertType = null;
...
mainApp.controller('UpdateController', function ($scope, $rootScope, $routeParams, $location, Vote) {
    $rootScope.lastPage = $location.$$path;
    $rootScope.alertType = null;
